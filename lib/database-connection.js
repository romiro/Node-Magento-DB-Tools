 ...
 *      sshConfig: object of ssh config properties to be used for SSH and mysql tunnel connections
 *      downloadPath: string defining the absolute path where db dumps will be downloaded to
